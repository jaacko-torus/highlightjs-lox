...
System.register(["highlight.js"], function (_export, _context) {
  "use strict";

  var hljs, regex, IDENT_RE, LANGUAGE_KEYWORDS, LITERALS, BUILT_IN_VARIABLES, KEYWORDS, NUMBER, PARAMS_CONTAINS, PARAMS, CLASS_OR_EXTENDS, FUNCTION_DEFINITION, UPPER_CASE_CONSTANT, FUNCTION_CALL, PROPERTY_ACCESS, lox;
  ...
  return {
    ...
    execute: function () {
      ...
      console.log(hljs);
      regex = hljs.regex;
      IDENT_RE = "[A-Za-z][0-9A-Za-z]*";
      LANGUAGE_KEYWORDS = ["class", "else", "for", "function", "if", "print", "return", "var", "while"];
      LITERALS = ["false", "nil", "true"];
      BUILT_IN_VARIABLES = ["super", "this"];
      KEYWORDS = {
        $pattern: IDENT_RE,
      ...
      PARAMS_CONTAINS = [hljs.C_LINE_COMMENT_MODE, // eat recursive parens in sub expressions
      {
        begin: /\(/,
        end: /\)/,
        keywords: KEYWORDS,
